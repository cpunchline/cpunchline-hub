...
set_target_properties(nng::nng PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libnng.so.2.0.0-dev"
  IMPORTED_SONAME_RELEASE "libnng.so.1"
  )

list(APPEND _cmake_import_check_targets nng::nng )
list(APPEND _cmake_import_check_files_for_nng::nng "${_IMPORT_PREFIX}/lib/libnng.so.2.0.0-dev" )
