...
int main(void)
{
    ...
    LOG_PRINT_INFO("ipc nng app2 is running!");

    reg_info.module_id = E_IPC_NNG_MODULE_ID_TEST2;
    strncpy(reg_info.module_name, "ipc_nng_app2", sizeof(reg_info.module_name));
    ...
    int notify = 1;
    ret = ipc_nng_send_notify(E_IPC_NNG_MODULE_ID_TEST2, E_IPC_NNG_MODULE_ID_TEST1, E_IPC_NNG_MSG_ID_TEST_NOTIFY,
    ...
    ret =
        ipc_nng_send_sync(E_IPC_NNG_MODULE_ID_TEST2, E_IPC_NNG_MODULE_ID_TEST1, E_IPC_NNG_MSG_ID_TEST_SYNC,
    ...
    int async_req = 3;
    ret = ipc_nng_send_async(E_IPC_NNG_MODULE_ID_TEST2, E_IPC_NNG_MODULE_ID_TEST1, E_IPC_NNG_MSG_ID_TEST_ASYNC,
    ...
    int broadcast = 4;
    ret = ipc_nng_send_broadcast(E_IPC_NNG_MODULE_ID_TEST2, E_IPC_NNG_MSG_ID_TEST_BROADCAST, (uint8_t *)&broadcast,
                                 sizeof(int));
    if (0 != ret)
    {
    ...
    ipc_nng_destroy(E_IPC_NNG_MODULE_ID_TEST2);
