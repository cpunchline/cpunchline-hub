...
int main(void)
{
    ...
    LOG_PRINT_INFO("ipc nng long app2 is running!");

    reg_info.module_id = E_IPC_NNG_LONG_MODULE_ID_TEST2;
    strncpy(reg_info.module_name, "ipc_nng_long_app2", sizeof(reg_info.module_name));
    ...
    ipc_nng_long_destroy(E_IPC_NNG_LONG_MODULE_ID_TEST2);
